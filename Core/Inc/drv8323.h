...
#define DRV_IS_FAULT()	!LL_GPIO_IsInputPinSet(DRV_nFAULT_GPIO_Port, DRV_nFAULT_Pin)

#define Drv8323_Enable  LL_GPIO_SetOutputPin(DRV_ENABLE_GPIO_Port, DRV_ENABLE_Pin)
#define Drv8323_Disable LL_GPIO_ResetOutputPin(DRV_ENABLE_GPIO_Port, DRV_ENABLE_Pin)
